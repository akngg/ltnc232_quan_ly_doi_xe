            ...
            <div className="driver-container">
                ...
                <ul className="driver-list" >
                    {drivers.map((driver, index) => 
                        <li key={index} className="li-driver-info">
                            Name: {driver.name}  <br/>
                            ...
                            <button id="delete-button" className="button-option" onClick={() => handleRemoveDriver(index)}>Delete</button>
                            <button id="change-button" className="button-option" onClick={() => handleChangeInfoDriver(driver, index)}>Change information</button>
                            <button id="moveUp-button" className="button-option" onClick={() => moveDriverUp(index)}>Move Up</button>
                            <button id="moveDown-button" className="button-option" onClick={() => moveDriverDown(index)}>Move Down</button>
                            </div>
                        </li>)}
                </ul>
                <form className="driver-input-form">
                    <fieldset>
                        ...
                        <div>
                            ...
                            <select id="degree" name="degree" onChange={handleDegreeChange} className="degree-select">
